    ...
    public List<Task> getTasks(Module m) {
        return List.of(
            createTask(m, "p1", "Der kaputte Roboter",
                "<p><strong>Story:</strong> Dein Roboter soll \"Hallo Welt\" sagen – aber er schweigt. Schau dir seinen Code an:</p><pre><code>nachricht = \"Hallo Welt\"\nPrint(nachricht)</code></pre><p><strong>Aufgabe:</strong> Was ist das Problem?</p>",
            ...
            createTask(m, "p2", "Variablen-Detektiv",
                "<p><strong>Story:</strong> Ein Kollege hat diesen Code geschrieben. Ohne ihn auszuführen: Was gibt <code>print(ergebnis)</code> am Ende aus?</p><pre><code>zahl = 10\nzahl = zahl + 5\nzahl = zahl * 2\nergebnis = zahl - 3\nprint(ergebnis)</code></pre><p><strong>Aufgabe:</strong> Berechne das Endergebnis im Kopf.</p>",
            ...
            createTask(m, "p3", "Lücke im Passwort-Generator",
                "<p><strong>Story:</strong> Du baust einen einfachen Passwort-Generator. Er soll 5 Sternchen ausgeben. Aber die Schleife fehlt noch:</p><pre><code>___ i ___ range(5):\n    print(\"*\")</code></pre><p><strong>Aufgabe:</strong> Ergänze die Lücken im Code.</p>",
            ...
            createTask(m, "p4", "FizzBuzz Klassiker",
                "<p><strong>Story:</strong> FizzBuzz ist ein legendärer Coding-Test in Vorstellungsgesprächen. Wenn du das löst, hättest du einen Job bekommen!</p><p><strong>Aufgabe:</strong> Schreibe Code, der die Zahlen 1–15 ausgibt – aber:<br>- Vielfache von 3 → <code>Fizz</code><br>- Vielfache von 5 → <code>Buzz</code><br>- Vielfache von 3 UND 5 → <code>FizzBuzz</code></p>",
            ...
            createTask(m, "p5", "Bug-Hunt: Die kaputte Funktion",
                "<p><strong>Story:</strong> Dein Kollege hat eine Funktion geschrieben, die den Flächeninhalt eines Rechtecks berechnen soll. Aber sie gibt immer das falsche Ergebnis zurück. Findest du den Bug?</p><pre><code>def flaeche(breite, hoehe):\n    return breite + hoehe\n\nprint(flaeche(4, 5))  # Sollte 20 ausgeben, gibt aber 9 aus</code></pre><p><strong>Aufgabe:</strong> Was muss geändert werden?</p>",
            ...
            createTask(m, "p6", "Countdown-Rakete",
                "<p><strong>Story:</strong> Houston, wir haben ein Problem – der Raketen-Countdown läuft rückwärts... oder doch nicht?</p><pre><code>___ i in range(10, ___, ___):\n    print(i)\nprint(\"🚀 Start!\")</code></pre><p><strong>Aufgabe:</strong> Ergänze den Code, damit von 10 bis 1 heruntergezählt wird.</p>",
            ...
            createTask(m, "p7", "Schere-Stein-Papier Logik",
                "<p><strong>Story:</strong> Du programmierst den Kern eines Schere-Stein-Papier-Spiels. Regeln: <code>\"schere\"</code> schlägt <code>\"papier\"</code>, <code>\"stein\"</code> schlägt <code>\"schere\"</code>, <code>\"papier\"</code> schlägt <code>\"stein\"</code>.</p><p><strong>Aufgabe:</strong> Schreibe eine Funktion <code>gewinner(spieler, computer)</code>, die den Gewinner (<code>\"spieler\"</code>, <code>\"computer\"</code> oder <code>\"unentschieden\"</code>) zurückgibt.</p>",
            ...
            createTask(m, "p8", "Startup-Pitch: Dein erstes Programm",
                "<p><strong>Story:</strong> Du hast 5 Minuten, um deine App-Idee einem Investor zu präsentieren!</p><p><strong>Aufgabe:</strong> Denk dir eine kleine App oder ein Programm aus, das du mit Python bauen würdest. Dann schreibe den Code (oder zumindest den wichtigsten Teil davon).</p>",
